...
import (
	...
	"github.com/jalapeno/bgpv4-graph/pkg/arangodb"
	"github.com/jalapeno/bgpv4-graph/pkg/kafkamessenger"
...
func main() {
	...
	dbSrv, err := arangodb.NewDBSrvClient(dbSrvAddr, dbUser, dbPass, dbName, peer,
		ebgpPeerV4, unicastprefixV4, ebgpprefixV4, inetprefixV4, bgpv4Graph, notifier)
	if err != nil {
